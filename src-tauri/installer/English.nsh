; Tauri NSIS strings (required — customLanguageFiles replaces the bundled file entirely)
...
; Graysoft branding (used by installer-hooks.nsh)
LangString welcomeText ${LANG_ENGLISH} "This wizard will install Graysoft Media Center on your computer.$\r$\n$\r$\nGenerate AI images and videos locally with curated one-click models.$\r$\n$\r$\nClick Next to continue."
LangString finishText ${LANG_ENGLISH} "Graysoft Media Center has been installed on your computer.$\r$\n$\r$\nLaunch the app, open Get Models, and start creating."
LangString runApp ${LANG_ENGLISH} "Launch Graysoft Media Center"
